...
func (mr *MockPrometheusClientInterfaceMockRecorder) GetLastActivityTime(query, interval interface{}) *gomock.Call {
...
func (m *MockPrometheusClientInterface) IsPrometheusHealthy(ctx context.Context) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsPrometheusHealthy", ctx)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPrometheusClientInterfaceMockRecorder) IsPrometheusHealthy(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsPrometheusHealthy", reflect.TypeOf((*MockPrometheusClientInterface)(nil).IsPrometheusHealthy), ctx)
}
