...
func (r *Reconciler) deleteClusterRoleBindings(
	...
	if err := r.deleteInstancesManagerBinding(ctx, ws); err != nil {
		return err
	}

	// Delete the ClusterRoleBinding for managing tenants
	if err := r.deleteTenantsManagerBinding(ctx, ws); err != nil {
		return err
	}
...
func (r *Reconciler) deleteInstancesManagerBinding(
	ctx context.Context,
	ws *v1alpha1.Workspace,
) error {
...
func (r *Reconciler) deleteTenantsManagerBinding(
	ctx context.Context,
	ws *v1alpha1.Workspace,
) error {
	// Create only the skeleton of the ClusterRoleBinding needed for deletion
