...
type GoCloakIface interface {
	...
	UpdateGroupManagementPermissions(ctx context.Context, accessToken, realm string, idOfGroup string, managementPermissions gocloak.ManagementPermissionRepresentation) (*gocloak.ManagementPermissionRepresentation, error)
	// UpdateClient updates the given Client
	UpdateClient(ctx context.Context, token, realm string, updatedClient gocloak.Client) error
	...
	UpdateClientManagementPermissions(ctx context.Context, accessToken, realm string, idOfClient string, managementPermissions gocloak.ManagementPermissionRepresentation) (*gocloak.ManagementPermissionRepresentation, error)
	...
	UpdateClientScope(ctx context.Context, token, realm string, scope gocloak.ClientScope) error
	...
	GetClient(ctx context.Context, token, realm, idOfClient string) (*gocloak.Client, error)
	...
	// GetClientOfflineSessions(ctx context.Context, token, realm, idOfClient string, params ...GetClientUserSessionsParams) ([]*gocloak.UserSessionRepresentation, error)
	// GetClientUserSessions returns user sessions associated with the client
	// GetClientUserSessions(ctx context.Context, token, realm, idOfClient string, params ...GetClientUserSessionsParams) ([]*gocloak.UserSessionRepresentation, error)
	...
	GetKeyStoreConfig(ctx context.Context, token, realm string) (*gocloak.KeyStoreConfig, error)
	// GetComponents get all components in realm
	GetComponents(ctx context.Context, token, realm string) ([]*gocloak.Component, error)
	...
	GetComponent(ctx context.Context, token, realm string, componentID string) (*gocloak.Component, error)
	...
	GetDefaultGroups(ctx context.Context, token, realm string) ([]*gocloak.Group, error)
	...
	GetRoleMappingByGroupID(ctx context.Context, token, realm, groupID string) (*gocloak.MappingsRepresentation, error)
	...
	GetGroup(ctx context.Context, token, realm, groupID string) (*gocloak.Group, error)
	...
	GetGroupManagementPermissions(ctx context.Context, token, realm string, idOfGroup string) (*gocloak.ManagementPermissionRepresentation, error)
	// GetGroupsByRole gets groups assigned with a specific role of a realm
	GetGroupsByRole(ctx context.Context, token, realm string, roleName string) ([]*gocloak.Group, error)
	// GetGroupsByClientRole gets groups with specified roles assigned of given client within a realm
	GetGroupsByClientRole(ctx context.Context, token, realm string, roleName string, clientID string) ([]*gocloak.Group, error)
	...
	// to the managed permissions
	GetClientManagementPermissions(ctx context.Context, token, realm string, idOfClient string) (*gocloak.ManagementPermissionRepresentation, error)
	// CreateRealmRole creates a role in a realm
	CreateRealmRole(ctx context.Context, token string, realm string, role gocloak.Role) (string, error)
	...
	GetUserCount(ctx context.Context, token string, realm string, params gocloak.GetUsersParams) (int, error)
	...
	CreateIdentityProvider(ctx context.Context, token string, realm string, providerRep gocloak.IdentityProviderRepresentation) (string, error)
	...
	GetPermissionScope(ctx context.Context, token, realm, idOfClient string, idOfScope string) (*gocloak.PolicyRepresentation, error)
	// UpdatePermissionScope updates a permission scope associated with the client
	UpdatePermissionScope(ctx context.Context, token, realm, idOfClient string, idOfScope string, policy gocloak.PolicyRepresentation) error
	// UpdateScope updates a scope associated with the client
	UpdateScope(ctx context.Context, token, realm, idOfClient string, scope gocloak.ScopeRepresentation) error
	...
	GetClientScopesScopeMappingsRealmRolesAvailable(ctx context.Context, token, realm, clientScopeID string) ([]*gocloak.Role, error)
	// GetClientScopesScopeMappingsRealmRoles returns roles associated with a client-scope
	GetClientScopesScopeMappingsRealmRoles(ctx context.Context, token, realm, clientScopeID string) ([]*gocloak.Role, error)
	// DeleteClientScopesScopeMappingsRealmRoles deletes realm-level roles from the client-scope
	DeleteClientScopesScopeMappingsRealmRoles(ctx context.Context, token, realm, clientScopeID string, roles []gocloak.Role) error
	// CreateClientScopesScopeMappingsRealmRoles creates realm-level roles to the client scope
	CreateClientScopesScopeMappingsRealmRoles(ctx context.Context, token, realm, clientScopeID string, roles []gocloak.Role) error
	// RegisterRequiredAction creates a required action for a given realm
	RegisterRequiredAction(ctx context.Context, token string, realm string, requiredAction gocloak.RequiredActionProviderRepresentation) error
	// GetRequiredActions gets a list of required actions for a given realm
	GetRequiredActions(ctx context.Context, token string, realm string) ([]*gocloak.RequiredActionProviderRepresentation, error)
	// GetRequiredAction gets a required action for a given realm
	GetRequiredAction(ctx context.Context, token string, realm string, alias string) (*gocloak.RequiredActionProviderRepresentation, error)
	// UpdateRequiredAction updates a required action for a given realm
	UpdateRequiredAction(ctx context.Context, token string, realm string, requiredAction gocloak.RequiredActionProviderRepresentation) error
	...
	// (not client's scope).
	DeleteClientScopesScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClientScope, idOfClient string, roles []gocloak.Role) error
	...
	UpdateUsersManagementPermissions(ctx context.Context, accessToken, realm string, managementPermissions gocloak.ManagementPermissionRepresentation) (*gocloak.ManagementPermissionRepresentation, error)
