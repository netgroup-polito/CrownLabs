...
func (r *Reconciler) enforceWorkspaces(
	ctx context.Context,
	log logr.Logger,
	tn *v1alpha2.Tenant,
) error {
	...
	for ws := range tn.Spec.Workspaces {
		nonBaseWorkspaces += r.enforceSingleWorkspace(ctx, log, tn, &tn.Spec.Workspaces[ws])
	}
...
func (r *Reconciler) enforceSingleWorkspace(
	ctx context.Context,
	log logr.Logger,
	tn *v1alpha2.Tenant,
