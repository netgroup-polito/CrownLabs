...
func SetContainerResourcesFromEnvironment(c *corev1.Container, env *clv1alpha2.Environment) {
	cpuRequestsMillis := env.Resources.CPU * int64(env.Resources.ReservedCPUPercentage) * 10
	...
	c.Resources = corev1.ResourceRequirements{
		...
		Limits: corev1.ResourceList{
			corev1.ResourceCPU:    *resource.NewQuantity(env.Resources.CPU, resource.DecimalSI),
			corev1.ResourceMemory: env.Resources.Memory.DeepCopy(),
		},
	}

	// Inject dynamic extended resources (e.g., nvidia.com/gpu)
	InjectOtherResources(env.Resources.OtherResources, c.Resources.Requests)
	InjectOtherResources(env.Resources.OtherResources, c.Resources.Limits)
}
