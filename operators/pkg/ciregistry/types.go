...
// UploadFiles struct for uploading image files along with annotations.
type UploadFiles struct {
	URLRepoImageTagPath
	MetadataFile multipart.File `formData:"annotations"`
	ImageFile    multipart.File `formData:"img"`
}

// BasicJSONReply struct of a basic response.
type BasicJSONReply struct {
