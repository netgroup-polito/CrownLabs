...
require (
	github.com/Jont828/cluster-api-visualizer v1.3.1
	github.com/Nerzal/gocloak/v7 v7.11.0
	github.com/clastix/cluster-api-control-plane-provider-kamaji v0.7.1
	github.com/clastix/kamaji v0.4.2
	...
	kubevirt.io/containerized-data-importer-api v1.59.2
