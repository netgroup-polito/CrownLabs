  ...
  const submitHandler = (t: Template) => {
    ...
    return createTemplateMutation({
      variables: {
        ...
        cleanupDeleteAfterCreation: t.cleanup?.deleteAfterCreation,
        cleanupStopAfterInactivity: t.cleanup?.stopAfterInactivity,
        cleanupDeleteAfterInactivity: t.cleanup?.deleteAfterInactivity,
