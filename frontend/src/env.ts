type envVarNames =
  ...
  | 'VITE_APP_CROWNLABS_GRAFANA_URL'
  | 'VITE_APP_CROWNLABS_BASTION_URL';
...
export const VITE_APP_CROWNLABS_GRAFANA_URL = getEnvVar(
  'VITE_APP_CROWNLABS_GRAFANA_URL',
);
export const VITE_APP_CROWNLABS_BASTION_URL = getEnvVar(
  'VITE_APP_CROWNLABS_BASTION_URL',
);
