...
export declare class EventsV1beta1Api {
     ...
     */
    createNamespacedEvent(namespace: string, body: V1beta1Event, includeUninitialized?: boolean, pretty?: string, dryRun?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     */
    replaceNamespacedEvent(name: string, namespace: string, body: V1beta1Event, pretty?: string, dryRun?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
