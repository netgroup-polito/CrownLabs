...
export declare class SchedulingV1beta1Api {
     ...
     */
    createPriorityClass(body: V1beta1PriorityClass, includeUninitialized?: boolean, pretty?: string, dryRun?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param dryRun When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     */
    replacePriorityClass(name: string, body: V1beta1PriorityClass, pretty?: string, dryRun?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
